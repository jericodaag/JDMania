...
$con=connect();
        ...
        $row = $users->fetch_assoc();
         ...
         //GIRLS
         $sql = "SELECT * FROM tblinventory where `type`='Tops' AND `category`='Kids' AND `subcategory`='Girls'";
         $gtops = $con->query($sql) or die ($con->error);
         $sql = "SELECT * FROM tblinventory where `type`='Bottoms' AND `category`='Kids' AND `subcategory`='Girls'";
         $gbots = $con->query($sql) or die ($con->error);
         $sql = "SELECT * FROM tblinventory where `type`='Dress' AND `category`='Kids' AND `subcategory`='Girls'";
...
<head>
    ...
    <title>LLC | Girl's Apparels</title>
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="kids-girls.php" class="active-kids-dropdown">Girls</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 kids girls banner-image-container">
                <h4 class="display-4">Girl's Apparels</h4>
    ...
    <!-- KID-GIRLS-TOPS ITEMS -->
    <div class="container text-center">
        <input type=hidden  id="girls-tops">
    ...
    <div id="girls-bottoms"></div>
    <!-- KID-GIRLS-BOTTOM ITEMS -->
    <div class="container text-center" >
        <div class="header-container">
    ...
    <div id="girls-dress"></div>
    <!-- KID-GIRLS-DRESS ITEMS -->
    <div class="container text-center">
   
        <div class="header-container" id=girls-dress>
            <span class="header">Dress</span>
        </div>
        <br><br><br>
        <div class="row">
