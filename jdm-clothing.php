...
$con=connect();
        ...
        $sql = "SELECT * FROM tblinventory where `type`='Dress' AND `category`='Women'";
        $wdress = $con->query($sql) or die ($con->error);
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="women-dress.php" class="active-women-dropdown">Dress</a>
                        </div>
                    </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 women banner-image-container">
                <h4 class="display-4">Women's Dress</h4>
    ...
    <div class="container text-center">
        <div class="row">
            <?php while($row = $wdress->fetch_array()){?>
