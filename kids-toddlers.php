...
$con=connect();
        ...
        //Toddlers
        $sql = "SELECT * FROM tblinventory where `category`='Kids' AND `subcategory`='Toddlers'";
...
<head>
    ...
    <title>LLC | Toddler's Apparels</title>
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="kids-toddlers.php" class="active-kids-dropdown">Toddlers</a>
                        </div>
                    </li>
                </ul>
                    <?php } else{ ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 kids toddlers banner-image-container">
                <h4 class="display-4">Toddler's Apparels</h4>
